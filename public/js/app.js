    ...
    _c(
      ...
      [
        ...
        _c("p", { staticClass: "card-text" }, [
          _vm._v("Date: " + _vm._s(_vm.FormatDate.format(_vm.date)))
        ]),
        _vm._v(" "),
        _c("p", { staticClass: "card-text" }, [
          _vm._v("Content: " + _vm._s(_vm.truncateText))
        ]),
        _vm._v(" "),
        _c(
          "router-link",
...
var staticRenderFns = [
  function() {
    ...
    return _c("main", [
      ...
      _c("p", [
        _vm._v(
          "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repudiandae similique, doloribus quas rerum nemo itaque suscipit reprehenderit, dicta culpa aut vero mollitia. Iure animi error dolorem blanditiis. Repudiandae quas esse a. Praesentium voluptatibus, cupiditate voluptatem ducimus id labore corporis assumenda eveniet dolore eius error itaque ex dolorem explicabo perferendis, libero velit repellat. Tempora commodi, rem ratione temporibus dolorum eligendi blanditiis necessitatibus sint tenetur, quae iste modi fugit alias ea consequatur error magnam, eveniet molestiae obcaecati perspiciatis excepturi vero harum! Vel aliquam doloribus, explicabo dolor magnam laboriosam porro asperiores quibusdam officia nobis animi doloremque? Dolorum ducimus, eum adipisci nam ipsa aliquid quas! At consequatur sapiente officiis ipsam ullam alias quis unde enim! Doloremque fugiat magnam molestiae laudantium rerum ad animi voluptatum ratione modi in eligendi omnis corporis perferendis incidunt aliquam reiciendis sint quibusdam, architecto impedit. Nostrum atque minima dolor neque ex voluptatum! Fugiat omnis excepturi commodi tempora aliquid delectus praesentium quisquam iusto deleniti, placeat aut libero laudantium reiciendis, quam officiis. Molestiae, quibusdam. Molestiae enim explicabo ad voluptate sed cum mollitia, beatae debitis doloremque cumque unde, sapiente deserunt ipsa a numquam minima eligendi libero inventore sint quibusdam. Incidunt impedit accusantium molestias itaque quos iure quam voluptatibus sed. Magnam iusto pariatur culpa esse!"
        )
      ])
    ])
  }
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("main", { staticClass: "container mt-4" }, [
  ...
  return !_vm.loaded
    ...
    : _c("div", { staticClass: "card mb-4" }, [
        _c("div", { staticClass: "card-body" }, [
          ...
          _c("p", { staticClass: "card-text" }, [
            _vm._v(
              "Date: " + _vm._s(_vm.FormatDate.format(_vm.post.created_at))
            )
          ]),
          _vm._v(" "),
          _c("p", { staticClass: "card-text" }, [
            _vm._v("Content: " + _vm._s(_vm.post.content))
          ])
        ])
      ])
}
...
__webpack_require__(/*! C:\Users\Kilgar\Desktop\BooleanEsercitazioni\laravel-boolpress\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Kilgar\Desktop\BooleanEsercitazioni\laravel-boolpress\resources\sass\app.scss */"./resources/sass/app.scss");
